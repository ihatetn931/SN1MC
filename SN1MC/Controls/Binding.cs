		...
		public static class GameInput_SetupDefaultControllerBindings__Patch
		{
			...
			static bool Prefix(GameInput __instance)
			{
				if (SN1MC.UsingSteamVR)
				{
					...
					GameInput.SetBindingInternal(GameInput.Device.Controller, GameInput.Button.Jump, GameInput.BindingSet.Primary, "Jump");
					GameInput.SetBindingInternal(GameInput.Device.Controller, GameInput.Button.PDA, GameInput.BindingSet.Primary, "PDA");
					GameInput.SetBindingInternal(GameInput.Device.Controller, GameInput.Button.Deconstruct, GameInput.BindingSet.Primary, "Deconstruct");
					GameInput.SetBindingInternal(GameInput.Device.Controller, GameInput.Button.Exit, GameInput.BindingSet.Primary, "Exit");
					GameInput.SetBindingInternal(GameInput.Device.Controller, GameInput.Button.LeftHand, GameInput.BindingSet.Primary, "LeftHand");
					GameInput.SetBindingInternal(GameInput.Device.Controller, GameInput.Button.RightHand, GameInput.BindingSet.Primary, "RightHand");
					GameInput.SetBindingInternal(GameInput.Device.Controller, GameInput.Button.AltTool, GameInput.BindingSet.Primary, "AltTool");
					GameInput.SetBindingInternal(GameInput.Device.Controller, GameInput.Button.TakePicture, GameInput.BindingSet.Primary, "TakePicture");
					GameInput.SetBindingInternal(GameInput.Device.Controller, GameInput.Button.Reload, GameInput.BindingSet.Primary, "Reload");
					GameInput.SetBindingInternal(GameInput.Device.Controller, GameInput.Button.MoveForward, GameInput.BindingSet.Primary, "MoveForward");
					GameInput.SetBindingInternal(GameInput.Device.Controller, GameInput.Button.MoveBackward, GameInput.BindingSet.Primary, "MoveBackward");
					GameInput.SetBindingInternal(GameInput.Device.Controller, GameInput.Button.MoveLeft, GameInput.BindingSet.Primary, "MoveLeft");
					GameInput.SetBindingInternal(GameInput.Device.Controller, GameInput.Button.MoveRight, GameInput.BindingSet.Primary, "MoveRight");
					GameInput.SetBindingInternal(GameInput.Device.Controller, GameInput.Button.MoveUp, GameInput.BindingSet.Primary, "MoveUp");
					GameInput.SetBindingInternal(GameInput.Device.Controller, GameInput.Button.MoveDown, GameInput.BindingSet.Primary, "MoveDown");
					GameInput.SetBindingInternal(GameInput.Device.Controller, GameInput.Button.Sprint, GameInput.BindingSet.Primary, "Sprint");
					GameInput.SetBindingInternal(GameInput.Device.Controller, GameInput.Button.LookUp, GameInput.BindingSet.Primary, "LookUp");
					GameInput.SetBindingInternal(GameInput.Device.Controller, GameInput.Button.LookDown, GameInput.BindingSet.Primary, "LookDown");
					GameInput.SetBindingInternal(GameInput.Device.Controller, GameInput.Button.LookLeft, GameInput.BindingSet.Primary, "LookLeft");
					GameInput.SetBindingInternal(GameInput.Device.Controller, GameInput.Button.LookRight, GameInput.BindingSet.Primary, "LookRight");
					GameInput.SetBindingInternal(GameInput.Device.Controller, GameInput.Button.CycleNext, GameInput.BindingSet.Primary, "CycleNext");
					GameInput.SetBindingInternal(GameInput.Device.Controller, GameInput.Button.CyclePrev, GameInput.BindingSet.Primary, "CyclePrev");
					GameInput.SetBindingInternal(GameInput.Device.Controller, GameInput.Button.UISubmit, GameInput.BindingSet.Primary, "UISubmit");
					GameInput.SetBindingInternal(GameInput.Device.Controller, GameInput.Button.UICancel, GameInput.BindingSet.Primary, "UICancel");
					GameInput.SetBindingInternal(GameInput.Device.Controller, GameInput.Button.UIClear, GameInput.BindingSet.Primary, "UIClear");
					GameInput.SetBindingInternal(GameInput.Device.Controller, GameInput.Button.UIAssign, GameInput.BindingSet.Primary, "UIAssign");
					GameInput.SetBindingInternal(GameInput.Device.Controller, GameInput.Button.UIMenu, GameInput.BindingSet.Primary, "UIMenu");
					GameInput.SetBindingInternal(GameInput.Device.Controller, GameInput.Button.UILeft, GameInput.BindingSet.Primary, "UILeft");
					GameInput.SetBindingInternal(GameInput.Device.Controller, GameInput.Button.UIRight, GameInput.BindingSet.Primary, "UIRight");
					GameInput.SetBindingInternal(GameInput.Device.Controller, GameInput.Button.UIDown, GameInput.BindingSet.Primary, "UIDown");
					GameInput.SetBindingInternal(GameInput.Device.Controller, GameInput.Button.UIUp, GameInput.BindingSet.Primary, "UIUp");
					GameInput.SetBindingInternal(GameInput.Device.Controller, GameInput.Button.UIAdjustLeft, GameInput.BindingSet.Primary, "UIAdjustLeft");
					GameInput.SetBindingInternal(GameInput.Device.Controller, GameInput.Button.UIAdjustRight, GameInput.BindingSet.Primary, "UIAdjustRight");
					GameInput.SetBindingInternal(GameInput.Device.Controller, GameInput.Button.UIRightStickAdjustLeft, GameInput.BindingSet.Primary, "UIRightStickAdjustLeft");
					GameInput.SetBindingInternal(GameInput.Device.Controller, GameInput.Button.UIRightStickAdjustRight, GameInput.BindingSet.Primary, "UIRightStickAdjustRight");
					GameInput.SetBindingInternal(GameInput.Device.Controller, GameInput.Button.UIPrevTab, GameInput.BindingSet.Primary, "UIPrevTab");
					GameInput.SetBindingInternal(GameInput.Device.Controller, GameInput.Button.UINextTab, GameInput.BindingSet.Primary, "UINextTab");
				}
				else
                {
					GameInput.ClearBindings(GameInput.Device.Controller);
