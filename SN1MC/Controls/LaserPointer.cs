...
namespace SN1MC.Controls
{
    public class LaserPointer : MonoBehaviour
    {
        ...
        public static Material[] myMaterials;
        void Start()
        {
            //Shader shader = Shader.Find("Transparent/Diffuse");
            //Shader shader = Shader.Find(ShaderManager.preloadedShaders.);
            ...
            //newMaterial.SetColor(ShaderPropertyID._Color2, colorBlue);
            //newMaterial.SetColor(ShaderPropertyID._Color3, colorBlue);
            //newMaterial.SetInt(ShaderPropertyID._MarmoSpecEnum, 20);
        ...
        public void LaserPointerSet(Vector3 end)
        {
            ...
            else if (VRMenuController.rightController != null)
            {
                line.SetPosition(0, transform.position);
                line.SetPosition(1, end);
                pointerDot.transform.position = new Vector3(end.x, end.y, end.z);
